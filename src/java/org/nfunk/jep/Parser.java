...
public class Parser/*@bgen(jjtree)*/implements ParserTreeConstants, ParserConstants {/*@bgen(jjtree)*/
  protected JJTParserState jjtree = new JJTParserState();private JEP     jep;
        ...
        public Node parseStream(java.io.Reader stream, JEP jep_in)
                ...
                // Return full tree if found more than one expression
        ...
        /**
	 * Parse expression with required return statement
	 */
        public Node parseCalcExpression(java.io.Reader stream, JEP jep_in) throws ParseException {
                restart(stream,jep_in);
                // Parse the expression, and return the 
                enable_tracing();
                Node node = CalcExpression();
                if (node == null) throw new ParseException("No expression entered");
...
***************************************************************/
 ...
 /*@bgen(jjtree) Start */
  ...
  final public ASTStart CalcExpression() throws ParseException {
                                    /*@bgen(jjtree) Start */
  ASTStart jjtn000 = new ASTStart(JJTSTART);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
...
/**
 * List of expressions with optional ending semicolon
 */
  ...
  final public void SequentialExpression() throws ParseException {
  ...
  final public void Conditional() throws ParseException {
    ...
    try {
      ...
      jj_consume_token(LCRV);
      ExpressionList();
      jj_consume_token(RCRV);
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case ELSE:
      ...
      default:
        ...
        ;
           ...
           jjtc001 = false;
         jjtn001.setOperator(opSet.getCond());
    } catch (Throwable jjte001) {
          if (jjtc001) {
            jjtree.clearNodeScope(jjtn001);
            jjtc001 = false;
  ...
  final public void UnaryExpressionNotPlusMinus() throws ParseException {
    ...
    default:
      ...
      if (jj_2_13(2147483647)) {
        ArrayAccess();
      } else if (jj_2_14(2147483647) && (jep.funTab.contains(getToken(1).image))) {
        Function();
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case INDENTIFIER1:
...
*/
  ...
  final public void ArgumentSeparator() throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case COMMA:
...
*/
  ...
  Object value;
    ...
    case INTEGER_LITERAL:
      ...
      break;
    case DEFAULT_FP_LITERAL:
      t = jj_consume_token(DEFAULT_FP_LITERAL);
      break;
    case ALT_FP_LITERAL:
      t = jj_consume_token(ALT_FP_LITERAL);
      break;
    default:
      jj_la1[27] = jj_gen;
      jj_consume_token(-1);
  ...
  final private boolean jj_3R_28() {
    ...
    jj_scanpos = xsp;
    lookingAhead = true;
    jj_semLA = jep.funTab.contains(getToken(1).image);
    lookingAhead = false;
  ...
  final private boolean jj_3R_59() {
    ...
    if (jj_scan_token(LCRV)) return true;
    if (jj_3R_10()) return true;
    if (jj_scan_token(RCRV)) return true;
    return false;
  }
  ...
  static {
   ...
   private static void jj_la1_0() {
      jj_la1_0 = new int[] {0x8000001,0x8000001,0x8000000,0x8000001,0x8000000,0x8000001,0x40000,0x0,0x0,0x80000000,0x80000000,0x60000000,0x60000000,0x0,0x0,0x0,0x0,0x0,0x2680,0x900000,0x18000000,0x900000,0x18000000,0x18000000,0x900000,0x910000,0x2680,0x2480,};
   }
   private static void jj_la1_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x10,0x8,0x4,0x4,0x3,0x3,0x60,0x60,0x2780,0x860,0x1000,0x0,0x14000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
