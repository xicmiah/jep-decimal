 ...
 * @author DPavlov
 */
public class BDSubtractNonstrict extends BigDecimalSubtract {

    @Override
    protected Number subNumber(Number v1, Number v2) throws ParseException {
