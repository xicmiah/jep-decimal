 ...
 * Caverts should work where arguments are Double, BigDecimal, Complex or String
 ...
 * <p/>
 * <p/>
 * <strong>Since 2.3.0 beta 1 </strong> a bit of a rewrite to make sub classing easier, now allows Complex to be compared to Double i.e. 1+0 i == 1.
 * <p/>
 * <strong> Since 2.3.0 beta 2 </strong> changed the internal lt,gt,le,ge,ne and eq method to return boolean.
...
public class Comparative extends PostfixMathCommand {
    ...
    public void run(Stack inStack) throws ParseException {
        ...
        inStack.push(new Double(res ? 1.0 : 0.0));
    }
    ...
    public boolean lt(Object param1, Object param2) throws ParseException {
        ...
        if (param1 instanceof BigDecimal && param2 instanceof BigDecimal) {
            return ((BigDecimal) param1).compareTo((BigDecimal) param2) < 0;
        }
